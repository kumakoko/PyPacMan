...
class Ghost(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.__pos_rect = pygame.Rect(0, 0, Ghost.FRAME_WIDTH, Ghost.FRAME_HEIGHT)
        self.__pos_rect.left = self.__center_pos[0] - Ghost.FRAME_WIDTH/2
        self.__pos_rect.top = self.__center_pos[1] - Ghost.FRAME_HEIGHT/2
        self.__maze = None
    ...
    def __BuildSubSurface(self):
        for i in range(6):
            src_rect = pygame.Rect(0, i*Ghost.FRAME_HEIGHT, Ghost.FRAME_WIDTH, Ghost.FRAME_HEIGHT)
    ...
    def Move(self, event):
        ...
        if key_pressed[pygame.K_LEFT]:
            ...
            new_rect = pygame.rect.Rect(
                cx-Ghost.FRAME_WIDTH/2, cy-Ghost.FRAME_HEIGHT/2, Ghost.FRAME_WIDTH, Ghost.FRAME_HEIGHT)
